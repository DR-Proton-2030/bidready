...
const Projects: React.FC<IGetProjectResponse> = ({
  ...
  return (
    <div className="space-y-6 px-5 sm:px-16 pt-10  bg-gradient-to-br from-slate-100 to-slate-200 min-h-[calc(100vh-64px)]">
      {/* Control Bar */}
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1 rounded-xl border border-slate-200/60 bg-white/60 p-1">
            ...
            >
              <SortVertical
                size={18}
                weight={viewMode === "board" ? "Bold" : "Linear"}
              />
            </button>
          </div>
          <Link
          ...
          >
            ...
            <span className="hidden sm:inline">
              {PROJECTS_TEXT.newProjectButton}
            </span>
          </Link>
        </div>
      </div>
