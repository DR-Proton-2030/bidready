...
const BACKEND_BASE = process.env.NEXT_PUBLIC_BASE_URL || process.env.BLUEPRINTS_API_URL || "http://localhost:8989";
...
export async function POST(req: Request) {
  try {
    ...
    const url = `${BACKEND_BASE}/api/v1/blueprints/save-blueprint-image-detection`;
